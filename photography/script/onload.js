...
window.onload = function () {
    ...
    } else windowModal (`Функционал сайта постепенно растет. Если сейчас что-то не работает, приходите позже - возможно, все уже будет работать. Логика сайта простроена на модульной системе скриптов.`)
}
